...
public class ModPlacedFeatures {
    public static final PlacedFeature EVERGREEN_PLACED = PlacementUtils.register("evergreen_placed", ModConfiguredFeatures.EVERGREEN_TREE_CHECKED.placed(VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.2f, 1))));
