...
public class ModPlacedFeatures {
    ...
    // ORES
    public static final Holder<PlacedFeature> ORE_ALUMINUM = PlacementUtils.register("ore_aluminum", ModConfiguredFeatures.ORE_ALUMINUM, ModOrePlacement.commonOrePlacement(10, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-16), VerticalAnchor.aboveBottom(128))));
    ...
    public static final Holder<PlacedFeature> ORE_IRIDIUM = PlacementUtils.register("ore_iridium", ModConfiguredFeatures.ORE_IRIDIUM, ModOrePlacement.commonOrePlacement(6, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-32), VerticalAnchor.aboveBottom(32))));
    public static final Holder<PlacedFeature> ORE_LEAD = PlacementUtils.register("ore_lead", ModConfiguredFeatures.ORE_LEAD, ModOrePlacement.commonOrePlacement(10, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(32), VerticalAnchor.aboveBottom(56))));
    ...
    public static final Holder<PlacedFeature> ORE_OSMIUM = PlacementUtils.register("ore_osmium", ModConfiguredFeatures.ORE_OSMIUM, ModOrePlacement.commonOrePlacement(4, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-80), VerticalAnchor.aboveBottom(80))));
    ...
    public static final Holder<PlacedFeature> ORE_PLATINUM = PlacementUtils.register("ore_platinum", ModConfiguredFeatures.ORE_PLATINUM, ModOrePlacement.commonOrePlacement(3, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(0), VerticalAnchor.aboveBottom(100))));
    public static final Holder<PlacedFeature> ORE_SILICON = PlacementUtils.register("ore_silicon", ModConfiguredFeatures.ORE_SILICON, ModOrePlacement.commonOrePlacement(7, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(0), VerticalAnchor.aboveBottom(50))));
