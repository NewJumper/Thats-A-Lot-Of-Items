...
public class ModPlacedFeatures {
    ...
    // ORES
    public static final Holder<PlacedFeature> ORE_ALUMINUM = PlacementUtils.register("ore_aluminum", ModConfiguredFeatures.ORE_ALUMINUM, ModOrePlacement.commonOrePlacement(11, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-16), VerticalAnchor.aboveBottom(64))));
    ...
    public static final Holder<PlacedFeature> ORE_LEAD = PlacementUtils.register("ore_lead", ModConfiguredFeatures.ORE_LEAD, ModOrePlacement.commonOrePlacement(11, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(32), VerticalAnchor.aboveBottom(56))));
