...
public class ModPlacedFeatures {
    // TREES
    public static final Holder<PlacedFeature> EVERGREEN_PLACED = PlacementUtils.register("evergreen_placed", ModConfiguredFeatures.EVERGREEN_SPAWN, VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.5f, 1)));
    public static final Holder<PlacedFeature> WILLOW_PLACED = PlacementUtils.register("willow_placed", ModConfiguredFeatures.WILLOW_SPAWN, VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, 0.5f, 1)));
    ...
    public static final Holder<PlacedFeature> ORE_OSMIUM_BURIED = PlacementUtils.register("ore_osmium_buried", ModConfiguredFeatures.ORE_OSMIUM_BURIED, ModOrePlacement.rareOrePlacement(3, HeightRangePlacement.triangle(VerticalAnchor.aboveBottom(-64), VerticalAnchor.aboveBottom(64))));
