...
public class ModTreeGeneration {
    ...
    public static void generateTrees(final BiomeLoadingEvent event) {
        ...
        if(biomeCheck(event.getName(), Biomes.SNOWY_PLAINS)) base.add(ModPlacedFeatures.EVERGREEN_PLACED);
        if(biomeCheck(event.getName(), Biomes.MEADOW)) base.add(ModPlacedFeatures.WILLOW_PLACED);
    }
