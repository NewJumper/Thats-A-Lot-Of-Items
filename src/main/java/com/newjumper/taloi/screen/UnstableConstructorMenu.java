...
public class UnstableConstructorMenu extends AbstractContainerMenu {
    ...
    public UnstableConstructorMenu(int pContainerId, Inventory pInventory, BlockEntity pBlockEntity, ContainerData pContainerData) {
        super(TaloiMenuTypes.UNSTABLE_CONSTRUCTOR_MENU.get(), pContainerId);
        ...
        this.blockEntity.getCapability(ForgeCapabilities.ITEM_HANDLER).ifPresent(handler -> {
            ...
            this.addSlot(new ResultSlot(handler, 4, 125, 37));
        });
    }
    ...
    public boolean stillValid(@NotNull Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, TaloiBlocks.UNSTABLE_CONSTRUCTOR.get());
    }
