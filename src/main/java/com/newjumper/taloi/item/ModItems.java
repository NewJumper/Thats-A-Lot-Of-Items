...
public class ModItems {
    ...
    public static final RegistryObject<Item> FERRONIOBIUM_PLATE = ITEMS.register("ferroniobium_plate", () -> new Item(new Item.Properties().tab(ModCreativeModeTab.TALOI_ITEM_TAB)));
