...
import com.newjumper.taloi.item.ModArmorMaterials;
...
public class SermiumArmorItem extends ArmorItem {
    private static final Map<ArmorMaterial, MobEffectInstance> MATERIAL_TO_EFFECT_MAP = (new ImmutableMap.Builder<ArmorMaterial, MobEffectInstance>()).put(ModArmorMaterials.SERMIUM, new MobEffectInstance(MobEffects.REGENERATION, 10, 0)).build();
