...
public class TaloiBlocks {
    ...
    /*public static final RegistryObject<StairBlock> STRIPPED_MANGROVE_WOOD_STAIRS = register("stripped_mangrove_wood_stairs", () -> new StrippableStairBlock(Blocks.STRIPPED_MANGROVE_WOOD::defaultBlockState, BlockBehaviour.Properties.copy(Blocks.STRIPPED_MANGROVE_WOOD).sound(SoundType.WOOD)));
    public static final RegistryObject<SlabBlock> STRIPPED_MANGROVE_WOOD_SLAB = register("stripped_mangrove_wood_slab", () -> new SlabBlock(BlockBehaviour.Properties.copy(Blocks.STRIPPED_MANGROVE_WOOD).sound(SoundType.WOOD)));
