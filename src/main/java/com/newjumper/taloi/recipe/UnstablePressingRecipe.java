...
public class UnstablePressingRecipe extends PressingRecipe {
    ...
    public RecipeSerializer<?> getSerializer() {
        return TaloiRecipes.UNSTABLE_PRESSING.get();
    }
    ...
    public static class Type implements RecipeType<UnstablePressingRecipe> {
        private Type() {}
        public static final Type INSTANCE = new Type();
    }

    public static class Serializer implements RecipeSerializer<UnstablePressingRecipe> {
        public static final Serializer INSTANCE = new Serializer();
        public static final ResourceLocation ID = new ResourceLocation(ThatsALotOfItems.MOD_ID,"unstable_pressing");

        @Override
        public UnstablePressingRecipe fromJson(ResourceLocation pRecipeId, JsonObject pSerializedRecipe) {
        ...
        @Override
        public UnstablePressingRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf pBuffer, UnstablePressingRecipe pRecipe) {
