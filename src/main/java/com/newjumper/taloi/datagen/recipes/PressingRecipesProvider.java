...
public class PressingRecipesProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        new PressingRecipeBuilder(ModItems.ALLOY_PLATE.get(), 1, 0f)
        ...
        new PressingRecipeBuilder(ModItems.BRONZE_PLATE.get(), 1, 0f)
                .requires(ModTags.Items.INGOTS_BRONZE, 2)
                .unlockedBy("has_material", has(ModTags.Items.INGOTS_BRONZE)).save(consumer);

        new PressingRecipeBuilder(ModItems.CARBON_PLATE.get(), 1, 0f)
        ...
        new UnstablePressingRecipeBuilder(ModItems.FORGE_PLATE.get(), 1, 0f)
        ...
        new UnstablePressingRecipeBuilder(ModItems.FUTURITE_PLATE.get(), 1, 0f)
        ...
        new PressingRecipeBuilder(ModItems.MAGNESIUM_PLATE.get(), 1, 0f)
                .requires(ModTags.Items.INGOTS_MAGNESIUM, 2)
                .unlockedBy("has_material", has(ModTags.Items.INGOTS_MAGNESIUM)).save(consumer);

        new PressingRecipeBuilder(ModItems.REINFORCED_COPPER_PLATE.get(), 1, 0f)
        ...
        new PressingRecipeBuilder(ModItems.SEMICONDUCTOR_PLATE.get(), 1, 0f)
                .requires(ModItems.GOLD_DISK.get())
                .requires(ModItems.MAGNESIUM_PLATE.get())
                .unlockedBy("has_material", has(ModItems.GOLD_DISK.get())).save(consumer);

        new UnstablePressingRecipeBuilder(ModItems.SERMIUM_PLATE.get(), 1, 0f)
