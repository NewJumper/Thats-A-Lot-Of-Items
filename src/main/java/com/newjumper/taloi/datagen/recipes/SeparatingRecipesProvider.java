...
public class SeparatingRecipesProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        // MINECRAFT
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.COAL_ORE), Blocks.STONE, Items.COAL, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.DEEPSLATE_COAL_ORE), Blocks.DEEPSLATE, Items.COAL, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.COPPER_ORE), Blocks.STONE, Items.COPPER_INGOT, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.DEEPSLATE_COPPER_ORE), Blocks.DEEPSLATE, Items.COPPER_INGOT, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.DIAMOND_ORE), Blocks.STONE, Items.DIAMOND, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.DEEPSLATE_DIAMOND_ORE), Blocks.DEEPSLATE, Items.DIAMOND, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.EMERALD_ORE), Blocks.STONE, Items.EMERALD, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.DEEPSLATE_EMERALD_ORE), Blocks.DEEPSLATE, Items.EMERALD, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.GOLD_ORE), Blocks.STONE, Items.GOLD_INGOT, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.DEEPSLATE_GOLD_ORE), Blocks.DEEPSLATE, Items.GOLD_INGOT, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.IRON_ORE), Blocks.STONE, Items.IRON_INGOT, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.DEEPSLATE_IRON_ORE), Blocks.DEEPSLATE, Items.IRON_INGOT, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.LAPIS_ORE), Blocks.STONE, Items.LAPIS_LAZULI, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.DEEPSLATE_LAPIS_ORE), Blocks.DEEPSLATE, Items.LAPIS_LAZULI, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.REDSTONE_ORE), Blocks.STONE, Items.REDSTONE, 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(Blocks.DEEPSLATE_REDSTONE_ORE), Blocks.STONE, Items.REDSTONE, 2)
        ...
        // TALOI
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.ALUMINUM_ORE.get()), Blocks.STONE, ModItems.RAW_ALUMINUM.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.DEEPSLATE_ALUMINUM_ORE.get()), Blocks.DEEPSLATE, ModItems.RAW_ALUMINUM.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.IRIDIUM_ORE.get()), Blocks.STONE, ModItems.RAW_IRIDIUM.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.DEEPSLATE_IRIDIUM_ORE.get()), Blocks.DEEPSLATE, ModItems.RAW_IRIDIUM.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.LEAD_ORE.get()), Blocks.STONE, ModItems.RAW_LEAD.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.DEEPSLATE_LEAD_ORE.get()), Blocks.DEEPSLATE, ModItems.RAW_LEAD.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.MAGNESIUM_ORE.get()), Blocks.STONE, ModItems.RAW_MAGNESIUM.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.DEEPSLATE_MAGNESIUM_ORE.get()), Blocks.DEEPSLATE, ModItems.RAW_MAGNESIUM.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.OSMIUM_ORE.get()), Blocks.STONE, ModItems.RAW_OSMIUM.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.DEEPSLATE_OSMIUM_ORE.get()), Blocks.DEEPSLATE, ModItems.RAW_OSMIUM.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.PLATINUM_ORE.get()), Blocks.STONE, ModItems.RAW_PLATINUM.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.DEEPSLATE_PLATINUM_ORE.get()), Blocks.DEEPSLATE, ModItems.RAW_PLATINUM.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.SILICON_ORE.get()), Blocks.STONE, ModItems.RAW_SILICON.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.DEEPSLATE_SILICON_ORE.get()), Blocks.DEEPSLATE, ModItems.RAW_SILICON.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.TIN_ORE.get()), Blocks.STONE, ModItems.RAW_TIN.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.DEEPSLATE_TIN_ORE.get()), Blocks.DEEPSLATE, ModItems.RAW_TIN.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.TUNGSTEN_ORE.get()), Blocks.STONE, ModItems.RAW_TUNGSTEN.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.DEEPSLATE_TUNGSTEN_ORE.get()), Blocks.DEEPSLATE, ModItems.RAW_TUNGSTEN.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.URANIUM_ORE.get()), Blocks.STONE, ModItems.RAW_URANIUM.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.DEEPSLATE_URANIUM_ORE.get()), Blocks.DEEPSLATE, ModItems.RAW_URANIUM.get(), 2)
        ...
        new SeparatingRecipeBuilder(Ingredient.of(ModBlocks.ZINC_ORE.get()), Blocks.STONE, ModItems.RAW_ZINC.get(), 2)
