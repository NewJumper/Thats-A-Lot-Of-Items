...
public class CraftingRecipesProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(TaloiBlocks.EVERGREEN_PLANKS.get(), 4)
                .requires(TaloiTags.Items.EVERGREEN_LOGS)
                .unlockedBy("has_log", has(TaloiTags.Items.EVERGREEN_LOGS)).save(consumer);
        ShapedRecipeBuilder.shaped(TaloiBlocks.STRIPPED_EVERGREEN_WOOD.get(), 3)
                .define('L', TaloiBlocks.STRIPPED_EVERGREEN_LOG.get())
                .pattern("LL")
                .pattern("LL")
                .unlockedBy("has_log", has(TaloiBlocks.STRIPPED_EVERGREEN_LOG.get())).save(consumer);
        ShapedRecipeBuilder.shaped(TaloiBlocks.EVERGREEN_WOOD.get(), 3)
                .define('L', TaloiBlocks.EVERGREEN_LOG.get())
                .pattern("LL")
                .pattern("LL")
                .unlockedBy("has_log", has(TaloiBlocks.EVERGREEN_LOG.get())).save(consumer);
        ShapedRecipeBuilder.shaped(TaloiBlocks.EVERGREEN_SLAB.get(), 6)
                .define('P', TaloiBlocks.EVERGREEN_PLANKS.get())
                .pattern("PPP")
                .unlockedBy("has_planks", has(TaloiBlocks.EVERGREEN_PLANKS.get())).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.EVERGREEN_STAIRS.get(), 4)
                ...
                .pattern("PPP")
                .unlockedBy("has_planks", has(TaloiBlocks.EVERGREEN_PLANKS.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(TaloiBlocks.EVERGREEN_BUTTON.get(), 1)
                .requires(TaloiBlocks.EVERGREEN_PLANKS.get())
                .unlockedBy("has_planks", has(TaloiBlocks.EVERGREEN_PLANKS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(TaloiBlocks.EVERGREEN_PRESSURE_PLATE.get(), 1)
                .define('P', TaloiBlocks.EVERGREEN_PLANKS.get())
                .pattern("PP")
                .unlockedBy("has_planks", has(TaloiBlocks.EVERGREEN_PLANKS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(TaloiBlocks.EVERGREEN_DOOR.get(), 3)
                .define('P', TaloiBlocks.EVERGREEN_PLANKS.get())
                .pattern("PP")
                .pattern("PP")
                .pattern("PP")
                .unlockedBy("has_planks", has(TaloiBlocks.EVERGREEN_PLANKS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(TaloiBlocks.EVERGREEN_TRAPDOOR.get(), 2)
                .define('P', TaloiBlocks.EVERGREEN_PLANKS.get())
                .pattern("PPP")
                .pattern("PPP")
                .unlockedBy("has_planks", has(TaloiBlocks.EVERGREEN_PLANKS.get())).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.EVERGREEN_WOOD_STAIRS.get(), 4)
                .define('W', TaloiBlocks.EVERGREEN_WOOD.get())
                .pattern("W  ")
                .pattern("WW ")
                .pattern("WWW")
                .unlockedBy("has_wood", has(TaloiBlocks.EVERGREEN_WOOD.get())).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.STRIPPED_EVERGREEN_WOOD_STAIRS.get(), 4)
                .define('W', TaloiBlocks.STRIPPED_EVERGREEN_WOOD.get())
                .pattern("W  ")
                .pattern("WW ")
                .pattern("WWW")
                .unlockedBy("has_wood", has(TaloiBlocks.STRIPPED_EVERGREEN_WOOD.get())).save(consumer);
        ...
        ShapelessRecipeBuilder.shapeless(TaloiBlocks.WILLOW_PLANKS.get(), 4)
                .requires(TaloiTags.Items.WILLOW_LOGS)
                .unlockedBy("has_log", has(TaloiTags.Items.WILLOW_LOGS)).save(consumer);
        ShapedRecipeBuilder.shaped(TaloiBlocks.STRIPPED_WILLOW_WOOD.get(), 3)
                .define('L', TaloiBlocks.STRIPPED_WILLOW_LOG.get())
                .pattern("LL")
                .pattern("LL")
                .unlockedBy("has_log", has(TaloiBlocks.STRIPPED_WILLOW_LOG.get())).save(consumer);
        ShapedRecipeBuilder.shaped(TaloiBlocks.WILLOW_WOOD.get(), 3)
                .define('L', TaloiBlocks.WILLOW_LOG.get())
                .pattern("LL")
                .pattern("LL")
                .unlockedBy("has_log", has(TaloiBlocks.WILLOW_LOG.get())).save(consumer);
        ShapedRecipeBuilder.shaped(TaloiBlocks.WILLOW_SLAB.get(), 6)
                .define('P', TaloiBlocks.WILLOW_PLANKS.get())
                .pattern("PPP")
                .unlockedBy("has_planks", has(TaloiBlocks.WILLOW_PLANKS.get())).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.WILLOW_STAIRS.get(), 4)
                ...
                .pattern("PPP")
                .unlockedBy("has_planks", has(TaloiBlocks.WILLOW_PLANKS.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(TaloiBlocks.WILLOW_BUTTON.get(), 1)
                .requires(TaloiBlocks.WILLOW_PLANKS.get())
                .unlockedBy("has_planks", has(TaloiBlocks.WILLOW_PLANKS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(TaloiBlocks.WILLOW_PRESSURE_PLATE.get(), 1)
                .define('P', TaloiBlocks.WILLOW_PLANKS.get())
                .pattern("PP")
                .unlockedBy("has_planks", has(TaloiBlocks.WILLOW_PLANKS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(TaloiBlocks.WILLOW_DOOR.get(), 3)
                .define('P', TaloiBlocks.WILLOW_PLANKS.get())
                .pattern("PP")
                .pattern("PP")
                .pattern("PP")
                .unlockedBy("has_planks", has(TaloiBlocks.WILLOW_PLANKS.get())).save(consumer);
        ShapedRecipeBuilder.shaped(TaloiBlocks.WILLOW_TRAPDOOR.get(), 2)
                .define('P', TaloiBlocks.WILLOW_PLANKS.get())
                .pattern("PPP")
                .pattern("PPP")
                .unlockedBy("has_planks", has(TaloiBlocks.WILLOW_PLANKS.get())).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.WILLOW_WOOD_STAIRS.get(), 4)
                .define('W', TaloiBlocks.WILLOW_WOOD.get())
                .pattern("W  ")
                .pattern("WW ")
                .pattern("WWW")
                .unlockedBy("has_wood", has(TaloiBlocks.WILLOW_WOOD.get())).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.STRIPPED_WILLOW_WOOD_STAIRS.get(), 4)
                .define('W', TaloiBlocks.STRIPPED_WILLOW_WOOD.get())
                .pattern("W  ")
                .pattern("WW ")
                .pattern("WWW")
                .unlockedBy("has_wood", has(TaloiBlocks.STRIPPED_WILLOW_WOOD.get())).save(consumer);
        ...
        // ALUMINUM
        ShapedRecipeBuilder.shaped(TaloiBlocks.ALUMINUM_BLOCK.get(), 1).define('I', TaloiTags.Items.INGOTS_ALUMINUM).pattern("III").pattern("III").pattern("III").unlockedBy("has_ingot", has(TaloiTags.Items.INGOTS_ALUMINUM)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.RAW_ALUMINUM_BLOCK.get(), 1).define('R', TaloiTags.Items.RAW_ALUMINUM).pattern("RRR").pattern("RRR").pattern("RRR").unlockedBy("has_raw_material", has(TaloiTags.Items.RAW_ALUMINUM)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.RAW_IRIDIUM_BLOCK.get(), 1).define('R', TaloiTags.Items.RAW_IRIDIUM).pattern("RRR").pattern("RRR").pattern("RRR").unlockedBy("has_raw_material", has(TaloiTags.Items.RAW_IRIDIUM)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiItems.IRIDIUM_INGOT.get(), 1).group("iridium").define('N', TaloiTags.Items.NUGGETS_IRIDIUM).pattern("NNN").pattern("NNN").pattern("NNN").unlockedBy("has_nugget", has(TaloiTags.Items.NUGGETS_IRIDIUM)).save(consumer, new ResourceLocation(ThatsALotOfItems.MOD_ID, "iridium_ingot_from_iridium_nugget"));

        // LEAD
        ShapedRecipeBuilder.shaped(TaloiBlocks.LEAD_BLOCK.get(), 1).define('I', TaloiTags.Items.INGOTS_LEAD).pattern("III").pattern("III").pattern("III").unlockedBy("has_ingot", has(TaloiTags.Items.INGOTS_LEAD)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.RAW_LEAD_BLOCK.get(), 1).define('R', TaloiTags.Items.RAW_LEAD).pattern("RRR").pattern("RRR").pattern("RRR").unlockedBy("has_raw_material", has(TaloiTags.Items.RAW_LEAD)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiItems.LEAD_INGOT.get(), 1).group("lead").define('N', TaloiTags.Items.NUGGETS_LEAD).pattern("NNN").pattern("NNN").pattern("NNN").unlockedBy("has_nugget", has(TaloiTags.Items.NUGGETS_LEAD)).save(consumer, new ResourceLocation(ThatsALotOfItems.MOD_ID, "lead_ingot_from_lead_nugget"));

        // MAGNESIUM
        ShapedRecipeBuilder.shaped(TaloiBlocks.MAGNESIUM_BLOCK.get(), 1).define('I', TaloiTags.Items.INGOTS_MAGNESIUM).pattern("III").pattern("III").pattern("III").unlockedBy("has_ingot", has(TaloiTags.Items.INGOTS_MAGNESIUM)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.RAW_MAGNESIUM_BLOCK.get(), 1).define('R', TaloiTags.Items.RAW_MAGNESIUM).pattern("RRR").pattern("RRR").pattern("RRR").unlockedBy("has_raw_material", has(TaloiTags.Items.RAW_MAGNESIUM)).save(consumer);
        ...
        // OSMIUM
        ShapedRecipeBuilder.shaped(TaloiBlocks.OSMIUM_BLOCK.get(), 1).define('I', TaloiTags.Items.INGOTS_OSMIUM).pattern("III").pattern("III").pattern("III").unlockedBy("has_ingot", has(TaloiTags.Items.INGOTS_OSMIUM)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.RAW_OSMIUM_BLOCK.get(), 1).define('R', TaloiTags.Items.RAW_OSMIUM).pattern("RRR").pattern("RRR").pattern("RRR").unlockedBy("has_raw_material", has(TaloiTags.Items.RAW_OSMIUM)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiItems.OSMIUM_INGOT.get(), 1).group("osmium").define('N', TaloiTags.Items.NUGGETS_OSMIUM).pattern("NNN").pattern("NNN").pattern("NNN").unlockedBy("has_nugget", has(TaloiTags.Items.NUGGETS_OSMIUM)).save(consumer, new ResourceLocation(ThatsALotOfItems.MOD_ID, "osmium_ingot_from_osmium_nugget"));

        // PLATINUM
        ShapedRecipeBuilder.shaped(TaloiBlocks.PLATINUM_BLOCK.get(), 1).define('I', TaloiTags.Items.INGOTS_PLATINUM).pattern("III").pattern("III").pattern("III").unlockedBy("has_ingot", has(TaloiTags.Items.INGOTS_PLATINUM)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.RAW_PLATINUM_BLOCK.get(), 1).define('R', TaloiTags.Items.RAW_PLATINUM).pattern("RRR").pattern("RRR").pattern("RRR").unlockedBy("has_raw_material", has(TaloiTags.Items.RAW_PLATINUM)).save(consumer);
        ...
        // SILICON
        ShapedRecipeBuilder.shaped(TaloiBlocks.SILICON_BLOCK.get(), 1).define('I', TaloiTags.Items.INGOTS_SILICON).pattern("III").pattern("III").pattern("III").unlockedBy("has_ingot", has(TaloiTags.Items.INGOTS_SILICON)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.RAW_SILICON_BLOCK.get(), 1).define('R', TaloiTags.Items.RAW_SILICON).pattern("RRR").pattern("RRR").pattern("RRR").unlockedBy("has_raw_material", has(TaloiTags.Items.RAW_SILICON)).save(consumer);
        ShapelessRecipeBuilder.shapeless(TaloiItems.RAW_SILICON.get(), 9).requires(TaloiTags.Items.RAW_STORAGE_SILICON).unlockedBy("has_nugget", has(TaloiTags.Items.RAW_STORAGE_SILICON)).save(consumer);

        // TIN
        ShapedRecipeBuilder.shaped(TaloiBlocks.TIN_BLOCK.get(), 1).define('I', TaloiTags.Items.INGOTS_TIN).pattern("III").pattern("III").pattern("III").unlockedBy("has_ingot", has(TaloiTags.Items.INGOTS_TIN)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.RAW_TIN_BLOCK.get(), 1).define('R', TaloiTags.Items.RAW_TIN).pattern("RRR").pattern("RRR").pattern("RRR").unlockedBy("has_raw_material", has(TaloiTags.Items.RAW_TIN)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiItems.TIN_INGOT.get(), 1).group("tin").define('N', TaloiTags.Items.NUGGETS_TIN).pattern("NNN").pattern("NNN").pattern("NNN").unlockedBy("has_nugget", has(TaloiTags.Items.NUGGETS_TIN)).save(consumer, new ResourceLocation(ThatsALotOfItems.MOD_ID, "tin_ingot_from_tin_nugget"));

        // TUNGSTEN
        ShapedRecipeBuilder.shaped(TaloiBlocks.TUNGSTEN_BLOCK.get(), 1).define('I', TaloiTags.Items.INGOTS_TUNGSTEN).pattern("III").pattern("III").pattern("III").unlockedBy("has_ingot", has(TaloiTags.Items.INGOTS_TUNGSTEN)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.RAW_TUNGSTEN_BLOCK.get(), 1).define('R', TaloiTags.Items.RAW_TUNGSTEN).pattern("RRR").pattern("RRR").pattern("RRR").unlockedBy("has_raw_material", has(TaloiTags.Items.RAW_TUNGSTEN)).save(consumer);
        ...
        // URANIUM
        ShapedRecipeBuilder.shaped(TaloiBlocks.URANIUM_BLOCK.get(), 1).define('I', TaloiTags.Items.INGOTS_URANIUM).pattern("III").pattern("III").pattern("III").unlockedBy("has_ingot", has(TaloiTags.Items.INGOTS_URANIUM)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.RAW_URANIUM_BLOCK.get(), 1).define('R', TaloiTags.Items.RAW_URANIUM).pattern("RRR").pattern("RRR").pattern("RRR").unlockedBy("has_raw_material", has(TaloiTags.Items.RAW_URANIUM)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiItems.REFINED_URANIUM.get(), 1).group("uranium").define('N', TaloiTags.Items.NUGGETS_URANIUM).pattern("NNN").pattern("NNN").pattern("NNN").unlockedBy("has_nugget", has(TaloiTags.Items.NUGGETS_URANIUM)).save(consumer, new ResourceLocation(ThatsALotOfItems.MOD_ID, "refined_uranium_from_uranium_bit"));

        // ZINC
        ShapedRecipeBuilder.shaped(TaloiBlocks.ZINC_BLOCK.get(), 1).define('I', TaloiTags.Items.INGOTS_ZINC).pattern("III").pattern("III").pattern("III").unlockedBy("has_ingot", has(TaloiTags.Items.INGOTS_ZINC)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.RAW_ZINC_BLOCK.get(), 1).define('R', TaloiTags.Items.RAW_ZINC).pattern("RRR").pattern("RRR").pattern("RRR").unlockedBy("has_raw_material", has(TaloiTags.Items.RAW_ZINC)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiItems.ZINC_INGOT.get(), 1).group("zinc").define('N', TaloiTags.Items.NUGGETS_ZINC).pattern("NNN").pattern("NNN").pattern("NNN").unlockedBy("has_nugget", has(TaloiTags.Items.NUGGETS_ZINC)).save(consumer, new ResourceLocation(ThatsALotOfItems.MOD_ID, "zinc_ingot_from_zinc_nugget"));

        // ALLOYS
        ShapedRecipeBuilder.shaped(TaloiBlocks.BRONZE_BLOCK.get(), 1).define('I', TaloiTags.Items.INGOTS_BRONZE).pattern("III").pattern("III").pattern("III").unlockedBy("has_ingot", has(TaloiTags.Items.INGOTS_BRONZE)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiBlocks.STEEL_BLOCK.get(), 1).define('I', TaloiTags.Items.INGOTS_STEEL).pattern("III").pattern("III").pattern("III").unlockedBy("has_ingot", has(TaloiTags.Items.INGOTS_STEEL)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiItems.FUTURITE.get(), 1).define('B', TaloiItems.FUTURITE_BIT.get()).pattern("BBB").pattern("BBB").pattern("BBB").unlockedBy("has_bit", has(TaloiItems.FUTURITE_BIT.get())).save(consumer, new ResourceLocation(ThatsALotOfItems.MOD_ID, "futurite_from_futurite_bit"));

        ShapedRecipeBuilder.shaped(TaloiItems.COPPER_PLATE.get(), 1).define('I', Tags.Items.INGOTS_COPPER).pattern("I").pattern("I").pattern("I").unlockedBy("has_ingot", has(Tags.Items.INGOTS_COPPER)).save(consumer);
        ...
        ShapedRecipeBuilder.shaped(TaloiItems.STEEL_PLATE.get(), 1).define('I', TaloiTags.Items.INGOTS_STEEL).pattern("I").pattern("I").pattern("I").unlockedBy("has_ingot", has(TaloiTags.Items.INGOTS_STEEL)).save(consumer);
