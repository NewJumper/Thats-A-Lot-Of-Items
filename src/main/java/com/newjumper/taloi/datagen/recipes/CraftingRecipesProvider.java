...
public class CraftingRecipesProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(ModBlocks.ORANGE_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.ORANGE_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.ORANGE_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.ORANGE_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.ORANGE_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.ORANGE_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.MAGENTA_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.MAGENTA_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.MAGENTA_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.MAGENTA_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.MAGENTA_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.MAGENTA_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.LIGHT_BLUE_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.LIGHT_BLUE_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.LIGHT_BLUE_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.LIGHT_BLUE_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.LIGHT_BLUE_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.LIGHT_BLUE_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.YELLOW_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.YELLOW_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.YELLOW_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.YELLOW_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.YELLOW_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.YELLOW_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.LIME_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.LIME_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.LIME_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.LIME_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.LIME_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.LIME_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.PINK_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.PINK_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.PINK_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.PINK_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.PINK_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.PINK_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.GRAY_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.GRAY_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.GRAY_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.GRAY_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.GRAY_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.GRAY_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.LIGHT_GRAY_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.LIGHT_GRAY_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.LIGHT_GRAY_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.LIGHT_GRAY_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.LIGHT_GRAY_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.LIGHT_GRAY_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.CYAN_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.CYAN_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.CYAN_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.CYAN_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.CYAN_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.CYAN_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.PURPLE_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.PURPLE_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.PURPLE_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.PURPLE_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.PURPLE_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.PURPLE_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.BLUE_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.BLUE_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.BLUE_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.BLUE_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.BLUE_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.BLUE_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.BROWN_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.BROWN_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.BROWN_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.BROWN_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.BROWN_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.BROWN_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.GREEN_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.GREEN_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.GREEN_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.GREEN_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.GREEN_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.GREEN_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.RED_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.RED_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.RED_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.RED_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.RED_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.RED_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.BLACK_TERRACOTTA_SLAB.get(), 6).define('T', Blocks.BLACK_TERRACOTTA).pattern("TTT").unlockedBy("has_material", has(Blocks.BLACK_TERRACOTTA)).save(consumer);
        ShapedRecipeBuilder.shaped(ModBlocks.BLACK_TERRACOTTA_STAIRS.get(), 4).define('T', Blocks.BLACK_TERRACOTTA).pattern("T  ").pattern("TT ").pattern("TTT").unlockedBy("has_material", has(Blocks.BLACK_TERRACOTTA)).save(consumer);
