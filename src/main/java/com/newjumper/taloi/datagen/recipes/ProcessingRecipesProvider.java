...
public class ProcessingRecipesProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
        new ProcessingRecipeBuilder(Ingredient.of(Items.COAL), Ingredient.of(Tags.Items.RAW_MATERIALS_IRON), ModItems.COAL_INFUSED_IRON_INGOT.get(), 1)
        ...
        new ProcessingRecipeBuilder(Ingredient.of(Items.DIAMOND), Ingredient.of(ModTags.Items.RAW_URANIUM), ModItems.DIAMOND_INFUSED_URANIUM.get(), 1)
                .unlockedBy("has_material", has(ModTags.Items.RAW_URANIUM)).save(consumer);

        new ProcessingRecipeBuilder(Ingredient.of(Items.EMERALD), Ingredient.of(ModTags.Items.RAW_OSMIUM), ModItems.EMERALD_INFUSED_OSMIUM_INGOT.get(), 1)
                .unlockedBy("has_material", has(ModTags.Items.RAW_OSMIUM)).save(consumer);

        new ProcessingRecipeBuilder(Ingredient.of(Items.EMERALD), Ingredient.of(ModTags.Items.RAW_TUNGSTEN), ModItems.EMERALD_INFUSED_TUNGSTEN_INGOT.get(), 1)
                .unlockedBy("has_material", has(ModTags.Items.RAW_TUNGSTEN)).save(consumer);

        new ProcessingRecipeBuilder(Ingredient.of(Items.EMERALD), Ingredient.of(ModTags.Items.RAW_ZINC), ModItems.EMERALD_INFUSED_ZINC_INGOT.get(), 1)
                .unlockedBy("has_material", has(ModTags.Items.RAW_ZINC)).save(consumer);

        new ProcessingRecipeBuilder(Ingredient.of(ModItems.FUTURITE_PLATE.get()), Ingredient.of(Tags.Items.INGOTS_NETHERITE), ModItems.FUTURITE_INFUSED_NETHERITE_INGOT.get(), 1)
