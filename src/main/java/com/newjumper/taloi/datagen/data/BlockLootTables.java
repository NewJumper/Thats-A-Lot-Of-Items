...
public class BlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.dropSelf(TaloiBlocks.MANGROVE_WOOD_STAIRS.get());
        this.add(TaloiBlocks.MANGROVE_WOOD_SLAB.get(), this::createSlabItemTable);
        this.dropSelf(TaloiBlocks.CHERRY_WOOD_STAIRS.get());
        this.add(TaloiBlocks.CHERRY_WOOD_SLAB.get(), this::createSlabItemTable);
