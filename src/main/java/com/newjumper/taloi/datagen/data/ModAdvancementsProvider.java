    ...
    protected void registerAdvancements(Consumer<Advancement> consumer, ExistingFileHelper fileHelper) {
        ...
        Advancement.Builder.advancement().parent(root)
                .display(TaloiItems.REFINED_URANIUM.get(),
                        Component.translatable("advancements.taloi.radioactive.title"),
                        Component.translatable("advancements.taloi.radioactive.description"),
        ...
        Advancement machinery = Advancement.Builder.advancement().parent(root)
                .display(TaloiItems.UNSTABLE_MACHINE_FRAME.get(),
                        Component.translatable("advancements.taloi.machinery.title"),
                        Component.translatable("advancements.taloi.machinery.description"),
                        null, FrameType.TASK, true, true, false)
        ...
        Advancement constructAlloy = Advancement.Builder.advancement().parent(machinery)
                .display(TaloiItems.STEEL_INGOT.get(),
                        Component.translatable("advancements.taloi.construct_alloy.title"),
                        Component.translatable("advancements.taloi.construct_alloy.description"),
                        null, FrameType.TASK, true, true, false)
        ...
        Advancement.Builder.advancement().parent(machinery)
                .display(TaloiItems.SILICON_PLATE.get(),
                        Component.translatable("advancements.taloi.press_material.title"),
                        Component.translatable("advancements.taloi.press_material.description"),
                        null, FrameType.TASK, true, true, false)
        ...
        Advancement.Builder.advancement().parent(machinery)
                .display(TaloiItems.COAL_INFUSED_IRON_INGOT.get(),
                        Component.translatable("advancements.taloi.infuse_ingot.title"),
                        Component.translatable("advancements.taloi.infuse_ingot.description"),
                        null, FrameType.TASK, true, true, false)
        ...
        Advancement obtainSermium = Advancement.Builder.advancement().parent(constructAlloy)
                .display(TaloiItems.SERMIUM.get(),
                        Component.translatable("advancements.taloi.obtain_sermium.title"),
                        Component.translatable("advancements.taloi.obtain_sermium.description"),
        ...
        Advancement.Builder.advancement().parent(obtainSermium)
                .display(TaloiItems.SERMIUM_CHESTPLATE.get(),
                        Component.translatable("advancements.taloi.sermium_armor.title"),
                        Component.translatable("advancements.taloi.sermium_armor.description"),
                        null, FrameType.GOAL, true, true, false)
        ...
        Advancement obtainFuturite = Advancement.Builder.advancement().parent(obtainSermium)
                .display(TaloiItems.FUTURITE.get(),
                        Component.translatable("advancements.taloi.obtain_futurite.title"),
                        Component.translatable("advancements.taloi.obtain_futurite.description"),
                        null, FrameType.GOAL, true, true, false)
                .rewards(AdvancementRewards.Builder.experience(25))
                .addCriterion("futurite", InventoryChangeTrigger.TriggerInstance.hasItems(TaloiItems.FUTURITE.get()))
        ...
        Advancement.Builder.advancement().parent(obtainFuturite)
                .display(TaloiItems.FUTURITE_CHESTPLATE.get(),
                        Component.translatable("advancements.taloi.futurite_armor.title"),
                        Component.translatable("advancements.taloi.futurite_armor.description"),
        ...
        Advancement.Builder.advancement().parent(obtainFuturite)
                .display(TaloiItems.FUTURITE_APPLE.get(),
                        Component.translatable("advancements.taloi.eat_futurite_apple.title"),
                        Component.translatable("advancements.taloi.eat_futurite_apple.description"),
                        null, FrameType.TASK, true, true, false)
