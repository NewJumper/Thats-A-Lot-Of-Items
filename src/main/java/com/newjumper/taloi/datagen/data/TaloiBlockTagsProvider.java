...
public class TaloiBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider pProvider) {
        tag(BlockTags.MINEABLE_WITH_AXE).add(TaloiBlocks.OAK_WOOD_STAIRS.get(), TaloiBlocks.SPRUCE_WOOD_STAIRS.get(), TaloiBlocks.BIRCH_WOOD_STAIRS.get(), TaloiBlocks.JUNGLE_WOOD_STAIRS.get(), TaloiBlocks.ACACIA_WOOD_STAIRS.get(), TaloiBlocks.DARK_OAK_WOOD_STAIRS.get(), TaloiBlocks.CRIMSON_HYPHAE_STAIRS.get(), TaloiBlocks.WARPED_HYPHAE_STAIRS.get(),
                TaloiBlocks.OAK_WOOD_SLAB.get(), TaloiBlocks.SPRUCE_WOOD_SLAB.get(), TaloiBlocks.BIRCH_WOOD_SLAB.get(), TaloiBlocks.JUNGLE_WOOD_SLAB.get(), TaloiBlocks.ACACIA_WOOD_SLAB.get(), TaloiBlocks.DARK_OAK_WOOD_SLAB.get(), TaloiBlocks.CRIMSON_HYPHAE_SLAB.get(), TaloiBlocks.WARPED_HYPHAE_SLAB.get(),
        ...
        tag(BlockTags.LOGS_THAT_BURN).add(TaloiBlocks.OAK_WOOD_STAIRS.get(), TaloiBlocks.SPRUCE_WOOD_STAIRS.get(), TaloiBlocks.BIRCH_WOOD_STAIRS.get(), TaloiBlocks.JUNGLE_WOOD_STAIRS.get(), TaloiBlocks.ACACIA_WOOD_STAIRS.get(), TaloiBlocks.DARK_OAK_WOOD_STAIRS.get(),
                TaloiBlocks.OAK_WOOD_SLAB.get(), TaloiBlocks.SPRUCE_WOOD_SLAB.get(), TaloiBlocks.BIRCH_WOOD_SLAB.get(), TaloiBlocks.JUNGLE_WOOD_SLAB.get(), TaloiBlocks.ACACIA_WOOD_SLAB.get(), TaloiBlocks.DARK_OAK_WOOD_SLAB.get(),
