...
public class TaloiBlockTagsProvider extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider pProvider) {
        tag(BlockTags.MINEABLE_WITH_AXE).addTags(TaloiTags.Blocks.WOOD_STAIRS, TaloiTags.Blocks.WOOD_SLABS).add(TaloiBlocks.CRIMSON_HYPHAE_STAIRS.get(), TaloiBlocks.WARPED_HYPHAE_STAIRS.get(), TaloiBlocks.CRIMSON_HYPHAE_SLAB.get(), TaloiBlocks.WARPED_HYPHAE_SLAB.get(), TaloiBlocks.STRIPPED_CRIMSON_HYPHAE_STAIRS.get(), TaloiBlocks.STRIPPED_WARPED_HYPHAE_STAIRS.get(), TaloiBlocks.STRIPPED_CRIMSON_HYPHAE_SLAB.get(), TaloiBlocks.STRIPPED_WARPED_HYPHAE_SLAB.get());

        tag(BlockTags.LOGS_THAT_BURN).addTags(TaloiTags.Blocks.WOOD_STAIRS, TaloiTags.Blocks.WOOD_SLABS);
