...
public class UnstablePressingRecipeBuilder implements RecipeBuilder {
    ...
    public UnstablePressingRecipeBuilder(ItemLike pResult, int pCount, float pExperience) {
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation pRecipeId) {
        ...
        consumer.accept(new UnstablePressingRecipeBuilder.Result(pRecipeId, this.result, this.count, this.ingredients, this.experience, this.advancement, new ResourceLocation(pRecipeId.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + pRecipeId.getPath())));
    }
