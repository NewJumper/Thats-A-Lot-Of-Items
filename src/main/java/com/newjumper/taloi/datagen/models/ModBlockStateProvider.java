...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    protected void registerStatesAndModels() {
        ...
        slabBlock(ModBlocks.ORANGE_TERRACOTTA_SLAB.get(), mcLoc("block/orange_terracotta"), mcLoc("block/orange_terracotta"));
        stairsBlock(ModBlocks.ORANGE_TERRACOTTA_STAIRS.get(), mcLoc("block/orange_terracotta"));
        slabBlock(ModBlocks.MAGENTA_TERRACOTTA_SLAB.get(), mcLoc("block/magenta_terracotta"), mcLoc("block/magenta_terracotta"));
        stairsBlock(ModBlocks.MAGENTA_TERRACOTTA_STAIRS.get(), mcLoc("block/magenta_terracotta"));
        slabBlock(ModBlocks.LIGHT_BLUE_TERRACOTTA_SLAB.get(), mcLoc("block/light_blue_terracotta"), mcLoc("block/light_blue_terracotta"));
        stairsBlock(ModBlocks.LIGHT_BLUE_TERRACOTTA_STAIRS.get(), mcLoc("block/light_blue_terracotta"));
        slabBlock(ModBlocks.YELLOW_TERRACOTTA_SLAB.get(), mcLoc("block/yellow_terracotta"), mcLoc("block/yellow_terracotta"));
        stairsBlock(ModBlocks.YELLOW_TERRACOTTA_STAIRS.get(), mcLoc("block/yellow_terracotta"));
        slabBlock(ModBlocks.LIME_TERRACOTTA_SLAB.get(), mcLoc("block/lime_terracotta"), mcLoc("block/lime_terracotta"));
        stairsBlock(ModBlocks.LIME_TERRACOTTA_STAIRS.get(), mcLoc("block/lime_terracotta"));
        slabBlock(ModBlocks.PINK_TERRACOTTA_SLAB.get(), mcLoc("block/pink_terracotta"), mcLoc("block/pink_terracotta"));
        stairsBlock(ModBlocks.PINK_TERRACOTTA_STAIRS.get(), mcLoc("block/pink_terracotta"));
        slabBlock(ModBlocks.GRAY_TERRACOTTA_SLAB.get(), mcLoc("block/gray_terracotta"), mcLoc("block/gray_terracotta"));
        stairsBlock(ModBlocks.GRAY_TERRACOTTA_STAIRS.get(), mcLoc("block/gray_terracotta"));
        slabBlock(ModBlocks.LIGHT_GRAY_TERRACOTTA_SLAB.get(), mcLoc("block/light_gray_terracotta"), mcLoc("block/light_gray_terracotta"));
        stairsBlock(ModBlocks.LIGHT_GRAY_TERRACOTTA_STAIRS.get(), mcLoc("block/light_gray_terracotta"));
        slabBlock(ModBlocks.CYAN_TERRACOTTA_SLAB.get(), mcLoc("block/cyan_terracotta"), mcLoc("block/cyan_terracotta"));
        stairsBlock(ModBlocks.CYAN_TERRACOTTA_STAIRS.get(), mcLoc("block/cyan_terracotta"));
        slabBlock(ModBlocks.PURPLE_TERRACOTTA_SLAB.get(), mcLoc("block/purple_terracotta"), mcLoc("block/purple_terracotta"));
        stairsBlock(ModBlocks.PURPLE_TERRACOTTA_STAIRS.get(), mcLoc("block/purple_terracotta"));
        slabBlock(ModBlocks.BLUE_TERRACOTTA_SLAB.get(), mcLoc("block/blue_terracotta"), mcLoc("block/blue_terracotta"));
        stairsBlock(ModBlocks.BLUE_TERRACOTTA_STAIRS.get(), mcLoc("block/blue_terracotta"));
        slabBlock(ModBlocks.BROWN_TERRACOTTA_SLAB.get(), mcLoc("block/brown_terracotta"), mcLoc("block/brown_terracotta"));
        stairsBlock(ModBlocks.BROWN_TERRACOTTA_STAIRS.get(), mcLoc("block/brown_terracotta"));
        slabBlock(ModBlocks.GREEN_TERRACOTTA_SLAB.get(), mcLoc("block/green_terracotta"), mcLoc("block/green_terracotta"));
        stairsBlock(ModBlocks.GREEN_TERRACOTTA_STAIRS.get(), mcLoc("block/green_terracotta"));
        slabBlock(ModBlocks.RED_TERRACOTTA_SLAB.get(), mcLoc("block/red_terracotta"), mcLoc("block/red_terracotta"));
        stairsBlock(ModBlocks.RED_TERRACOTTA_STAIRS.get(), mcLoc("block/red_terracotta"));
        slabBlock(ModBlocks.BLACK_TERRACOTTA_SLAB.get(), mcLoc("block/black_terracotta"), mcLoc("block/black_terracotta"));
        stairsBlock(ModBlocks.BLACK_TERRACOTTA_STAIRS.get(), mcLoc("block/black_terracotta"));
